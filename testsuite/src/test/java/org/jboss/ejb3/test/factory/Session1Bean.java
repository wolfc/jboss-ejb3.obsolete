...
public class Session1Bean implements Session1
{
   ...
   @PersistenceContext(unitName="../session2.jar#manager2") EntityManager manager2;
   @PersistenceUnit(unitName="manager1") SessionFactory factory1;
   @PersistenceUnit(unitName="../session2.jar#manager2") EntityManagerFactory factory2;
   ...
   {
      EntityManager enc = (EntityManager)ctx.lookup("encManager1");
      Entity1 first = new Entity1();
      first.setString("blah");
      enc.persist(first);
