...
extends JBossTestCase
{
   ...
   public void testAll() throws Exception
   {
      ...
      assertEquals(c.getAddress().getState(), "MA");
      assertEquals(c.getAddress2().state, "MA");
      assertEquals(c.getAddress2().city, "Bedford");
   }

   public void testFieldAll() throws Exception
   {
      EntityTest tester = (EntityTest) getInitialContext().lookup("EntityTestBean/remote");
      FieldCustomer c = tester.createFieldCustomer();
      c = tester.fieldFindByCustomerId(c.getId());
