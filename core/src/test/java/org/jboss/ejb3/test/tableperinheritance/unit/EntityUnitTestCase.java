 ...
 */
package org.jboss.ejb3.test.tableperinheritance.unit;

import org.jboss.ejb3.test.tableperinheritance.EntityTest;
...
extends JBossTestCase
{
   ...
   {
      return getDeploySetup(EntityUnitTestCase.class, "table-per-class-inheritance-test.jar");
   }
