...
@Stateful(name="Foo1")
@Remote(Foo.class)
public class FooBean1 implements Foo, java.io.Serializable
{
   private static final Logger log = Logger.getLogger(FooBean1.class);
   
   private boolean transactionExisted = false;
   ...
   {
      transactionExisted = (tm.getTransaction() != null);
   }
   
   @PermitAll
   public boolean transactionExisted()
   {
