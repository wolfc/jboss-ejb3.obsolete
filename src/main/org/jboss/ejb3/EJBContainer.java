...
public abstract class EJBContainer extends ClassContainer implements Container, InjectionContainer, JavaEEComponent
{
   ...
   protected AnnotationsMetaData annotationMetadata;
   ...
   public AnnotationsMetaData getAnnotationMetadata()
   {
      return annotationMetadata;
   }
   
   public void setAnnotationMetadata(AnnotationsMetaData annotationMetadata)
   {
   ...
   public void create() throws Exception
   {
      ...
      log.info("!!!!!!!!!!!!!!!!!! create " + this.getEjbName() + " " + this.getMetadata());
   }
   ...
   public void start() throws Exception
   {
      ...
      log.info("!!!!!!!!!!!!!!!!!! start " + this.getEjbName() + " " + this.getMetadata());
