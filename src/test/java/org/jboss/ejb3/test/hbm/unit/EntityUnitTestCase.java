...
import org.jboss.ejb3.test.hbm.HBM;
...
extends JBossTestCase
{
   ...
   public void testAll() throws Exception
   {
      ...
      tester.createBoth();
      List annotated = tester.findAnnotated();
      assertEquals(annotated.size(), 1);
      Annotated an = (Annotated)annotated.get(0);
      HBM hbm = an.getHbm();
      assertEquals(hbm.getName(), "Gavin");
      assertEquals(tester.findHBM().size(), 1);
   }
