...
{
   Customer oneToManyCreate(String name) throws Exception;

   Customer findCustomerByPk(CustomerPK pk) throws Exception;
   ...
   FieldCustomer fieldOneToManyCreate(String name) throws Exception;

   FieldCustomer fieldFindCustomerByPk(FieldCustomerPK pk) throws Exception;
