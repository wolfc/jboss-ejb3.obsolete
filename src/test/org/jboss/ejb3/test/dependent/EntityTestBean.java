...
public class EntityTestBean implements EntityTest
{
   ...
   public Customer createCustomer()
   {
      ...
      FieldAddress faddress = new FieldAddress();
      faddress.street = "Boston Road";
      faddress.city = "Bedford";
      faddress.state = "MA";
      faddress.zip = "01811";
      c.setAddress2(faddress);
      manager.persist(c);
      return c;
   }
   ...
   public FieldCustomer fieldFindByCustomerId(Long id)
   {
